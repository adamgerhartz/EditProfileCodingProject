...
//    private final Rect mBounds = new Rect();
    ...
    private final boolean mIsShowInFirstItem;
     ...
     * @param isShowInFirstItem Whether show the divider in last item.
     */
    public CustomDividerItemDecoration(Context context, int orientation, boolean isShowInFirstItem) {
        ...
        this.mIsShowInFirstItem = isShowInFirstItem;
    }
    ...
    private void drawVertical(Canvas canvas, RecyclerView parent) {
        ...
        int startCount;
        if (mIsShowInFirstItem) {
            startCount = 0;
        } else {
            startCount = 1;
        }
        for (int i = startCount; i < parent.getChildCount(); i++) {
